# Security Auditor — OpenSkills Skill Design

## Overview

A security auditing agent for opencode / antigravity that performs complete security assessment of vibecoding/AI-generated projects. Works as both an invocable skill and a recommended post-implementation gate.
